...
<section class="jumbotron jumbotron-ms1 ">
      ...
      <p class="empresa text-center"><em>“Nos aseguramos de responder a las necesidades de cada cliente mediante soluciones específicas para sus proyectos”.</em></p> 
</br></br></br></br>
</section>
         ...
         <div class="form-body">
            ...
            <div class="form-group">
                   <div class="input-group">
                     <!-- PRESENTADO  <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div> -->
            ...
            <div class="form-group has-danger">
              ...
              <div class="form-group">
                   <div class="input-group">
                   <!-- PRESENTADO <div class="input-group-addon"><span class="glyphicon glyphicon-home"></span></div> -->
                   <!-- <input name="name" type="text" class="form-control" placeholder="Username"> -->
              ...
              <div class="form-group">
                   <div class="input-group">
                   <!-- PRESENTADO <div class="input-group-addon"><span class="glyphicon glyphicon-phone-alt"></span></div> -->
                   <!-- <input name="name" type="text" class="form-control" placeholder="Username"> -->
              ...
              <div class="form-group">
                   ...
                   <!-- PRESENTADO <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div> -->
               ...
               <div class="form-group">
                   ...
                   <!-- PRESENTADO <div class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></div> -->
                   <!-- <input name="email" type="text" class="form-control" placeholder="Email"> -->
  ...
  <div class="containe-fluid">
    <div class="row">
      <div class="col-xs-12">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3365.976010726337!2d-117.01791985054471!3d32.4733334066244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d937b8d7a1d771%3A0x4fbe54b01e09a90b!2sMarketing+Steel+Comercializadora!5e0!3m2!1sen!2smx!4v1508035209637" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen line-height="0"></iframe>
